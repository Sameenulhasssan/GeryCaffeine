  ...
  proceed(String tokenId) async {
    ...
    final response = isHomeDeliverySelected
        ? await http.post(url, body: {
            ...
            "food_desc": food_desc,
            "total_price": (widget.price + widget.deliveryCharges).toString(),
            "latlong": langLat.toString(),
            "token": token,
            "delivery_charges": "${widget.deliveryCharges.toStringAsFixed(2)}",
            "delivery_mode": "0",
            "phone_no": phone,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '$CURRENCY ${widget.price.toStringAsFixed(2)}',
                                        style: TextStyle(
                                            fontFamily: 'GlobalFonts',
                                            color: GREY,
                                            fontSize: 12,
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        isHomeDeliverySelected
                                            ? '$CURRENCY ${widget.deliveryCharges.toStringAsFixed(2)}'
                                            : '$CURRENCY 0',
                                        style: TextStyle(
                                            fontFamily: 'GlobalFonts',
                                            color: GREY,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        isHomeDeliverySelected
                                            ? '$CURRENCY ${(widget.price + widget.deliveryCharges).toStringAsFixed(2)}'
                                            : '$CURRENCY ${widget.price.toStringAsFixed(2)}',
                                        style: TextStyle(
                                            fontFamily: 'GlobalFonts',
                                            color: GREY,
                            ...
                            child: Container(
                              child: Column(
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      addedLocations = await Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  AllLocations()));
                                ...
                                if (stripeToken != null) {
                                  ...
                                  proceed(stripeToken);
                                    ...
                                    // }
                                      ...
                                      Toast.show(
                                          PLEASE_SELECT_PAYMENT_METHOD, context,
                                          duration: 2);
                                    }
                                    //proceed();
