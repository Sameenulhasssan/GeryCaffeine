...
class _LoginAsCustomerState extends State<LoginAsCustomer> {
  ...
  loginInto() async {
    if (phoneNumber.length < PHONE_NUMBER_LENGTH) {
      ...
      String url =
          "$SERVER_ADDRESS/api/login?mobile_no=$phoneNumber&password=$pass&token=$token";
      ...
      if (jsonResponse['data']['success'] == "0") {
        ...
        await SharedPreferences.getInstance().then((pref) {
          ...
          pref.setString(
              "userId", jsonResponse['data']['register']['user_id'].toString());
            ...
            content: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      PLEASE_WAIT_WHILE_LOGGING_INTO_ACCOUNT,
                      style: TextStyle(
