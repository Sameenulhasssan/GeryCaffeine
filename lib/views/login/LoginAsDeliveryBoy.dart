      ...
      try {
        ...
        if (jsonResponse['data']['success'] == "0") {
          ...
          await SharedPreferences.getInstance().then((pref) {
            ...
            pref.setString(
                "userId", jsonResponse['data']['login'][0]['id'].toString());
            pref.setString("name", jsonResponse['data']['login'][0]['name']);
            pref.setString(
                "phone", jsonResponse['data']['login'][0]['mobile_no']);
            pref.setString("email", jsonResponse['data']['login'][0]['email']);
            pref.setString(
                "vehicle_no", jsonResponse['data']['login'][0]['vehicle_no']);
            pref.setString("vehicle_type",
                jsonResponse['data']['login'][0]['vehicle_type']);
