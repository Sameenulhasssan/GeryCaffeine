...
class DeliveryBoyOrderHistory extends StatefulWidget {
  @override
  _DeliveryBoyOrderHistoryState createState() =>
      _DeliveryBoyOrderHistoryState();
}
...
class _DeliveryBoyOrderHistoryState extends State<DeliveryBoyOrderHistory> {
  ...
  getOrderHistory() async {
    ...
    final response =
        await get("$SERVER_ADDRESS/api/order_history?deliverboy_id=$id")
            .catchError((e) {
      setState(() {
                          ...
                          return InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          DeliveryBoyOrderDetails(orderHistory
                                              .order[index].orderNo
                                              .toString())));
                            },
                            child: Container(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        "$ORDER_NUMBER: " +
                                            orderHistory.order[index].orderNo
                                                .toString(),
                                        style: TextStyle(
                                          fontFamily: 'Bergen',
                                          color: BLACK,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            orderHistory.order[index].status
                                                        .length >
                                                    9
                                                ? orderHistory
                                                    .order[index].status
                                  ...
                                  Text(
                                    orderHistory.order[index].address,
                                    style: TextStyle(
                                      fontFamily: 'Bergen',
                                      color: GREY,
                                      fontSize: 12,
