  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Image.asset("assets/icons/logo_cart.png"),
                            InkWell(
                              child: Image.asset(
                              ...
                              child: Column(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ListTile(
                                                                        ...
                                                                        : Container(
                                                                            child:
                                                                              ...
                                                                              children: List.generate(list[index].toppings.length, (i) {
                                                                                return Text(
                                                                                  "${list[index].toppings[i].toppingName}${i < list[index].toppings.length - 1 ? "," : ""}",
                                                                                  style: TextStyle(
                                                                                    fontFamily: 'Bergen',
                                                                                    color: THEME_COLOR,
                                                                                    fontSize: 10,
                                                        ...
                                                        trailing: Text(
                                                          "${(double.parse(list[index].itemTotalPrice).toStringAsFixed(2)).replaceAll('.', ',')} $CURRENCY",
                                                          style: TextStyle(
                                                            fontFamily:
                                                                'Bergen',
                                                            color: WHITE,
                                ...
                                leading: CircleAvatar(
                                  ...
                                  backgroundImage: AssetImage(
                                      "assets/icons/delievery-icon.png"),
                                ),
                                title: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ALL_ORDERS_FOR_HOME_DELIVERY_WILL_COST_MORE +
                                          " ${(widget.deliveryCharges.toStringAsFixed(2)).replaceAll('.', ',')} $CURRENCY",
                                      style: TextStyle(
                                        fontFamily: 'Bergen',
                                        color: THEME_COLOR,
                                        fontSize: 10,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "${(totalPrice.toStringAsFixed(2)).replaceAll('.', ',')} $CURRENCY",
                            style: TextStyle(
                                fontFamily: 'Bergen',
                                color: WHITE,
                                fontWeight: FontWeight.bold,
                        ...
                        children: [
                          Expanded(
                            child: RaisedButton(
                              ...
                              child: Text(
                                isLoggedIn ? CHECKOUT : LOGIN_TO_PROCEED,
                                style: TextStyle(
                                    fontFamily: 'Bergen',
                                    color: WHITE,
                                    fontSize: 18,
        ...
        drawer: Container(
            child: SideMenu(int.parse(widget.deliveryCharges.toString()))),
      ),
    );
  }
