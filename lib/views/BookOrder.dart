                                      ...
                                      return InkWell(
                                        onTap: () {
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      OrderProgress(list[index]
                                                          .order_id)));
                                        },
                                        child: Container(
                                          margin:
                                              EdgeInsets.fromLTRB(0, 8, 8, 10),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "$ORDER_NUMBER : ${list[index].order_no}",
                                                          style: TextStyle(
                                                            fontFamily:
                                                                'Bergen',
                                                            color: BLACK,
                                                        ...
                                                        Text(
                                                          "$CURRENCY${double.parse(list[index].total_amount).toStringAsFixed(2)}",
                                                          style: TextStyle(
                                                              fontFamily:
                                                                  'Bergen',
                                                              color: BLACK,
                                                ...
                                                Text(
                                                  "${list[index].address == null ? ORDER_FOR_PICKUP : list[index].address}",
                                                  style: TextStyle(
                                                    fontFamily: 'Bergen',
                                                    color: GREY,
                                                    fontSize: 12,
